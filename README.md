...
```bash
$ git clone https://github.com/robertoachar/playground-electron.git
```
...
[MIT](https://github.com/robertoachar/playground-electron/blob/master/LICENSE)

[license-badge]: https://img.shields.io/github/license/robertoachar/playground-electron.svg
